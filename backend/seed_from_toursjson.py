...
def emit(data, out):
    ...
    for t in tours:
        w(
            ...
            "additional_image_urls, kind, intro_audio_url, total_duration_seconds, "
            ...
            f"{text_array(t.get('additionalImageURLs'))}, {q(t['kind'])}, "
            ...
            "additional_image_urls = excluded.additional_image_urls, kind = excluded.kind, "

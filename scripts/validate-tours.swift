...
let architectTags: Set<String> = [
    ...
    "Agostinho Ricca", "Aires Mateus", "Albert Guilbert",
    "Alberto Kuhlmann", "Alberto Prebisch", "Alejandro Christophersen",
    "Alexander Jackson Davis", "Alfred Foulhoux", "Alfred Waterhouse",
    "Allan Powell", "Américo Soares Braga", "Annabelle Selldorf",
    "Antonio Citterio", "António Correia da Silva", "Artur Andrade",
    "Arturo Ochoa", "Baek Jong-hwan", "Bertrand Goldberg",
    "Bonaventura Bassegoda", "Bond Ryder", "Brad Cloepfil",
    "Bruce Price", "Carlo Maciachini", "Carlos Zapata",
    "Charles Collens", "Charles Garnier", "Charles W. Clinton",
    "Chu Ming Silveira", "DHK Architects", "Dan Kiley",
    "Daniel Libeskind", "David Chipperfield", "David McGlashan",
    "David Rockwell", "Der Scutt", "Diogo de Boitaca",
    "Domiziano Rossi", "Donald Deskey", "Edgar de Oliveira da Fonseca",
    "Edson Elito", "Eduardo Catalano", "Eduardo Le Monnier",
    "Edward Durell Stone", "Egon Eiermann", "Ellen van Loon",
    "Emanuel Buchsbaum", "Emili Sala Cortés", "Emilio Lancia",
    "Emílio David", "Enrique Jan", "Ensamble Studio",
    "Eugène Ferret", "Eugénio dos Santos", "Fermín Vázquez",
    "Fernand Gardès", "Filippo Terzi", "Francesco Gianotti",
    "Francisco Joaquim Béthencourt da Silva", "Francisco de Paula del Villar", "Franz Koepp",
    "François Hennebique", "Frederick A. Petersen", "Fumio Asakura",
    "George McRae", "Gio Ponti", "Giovanni Muzio",
    "Giuseppe Cinatti", "Giuseppe Mengoni", "Giuseppe Piermarini",
    "Gonçalo Ribeiro Telles", "Guiniforte Solari", "Gustavo Adolfo Gonçalves e Sousa",
    "H. Douglas Ives", "H3O Architects", "Hector Guimard",
    "Hendrick de Keyser", "Henry C. Pelton", "Henry Janeway Hardenbergh",
    "Hercules Manfredi", "Hiroshi Naito", "Hiroyuki Wakabayashi",
    "Ico Migliore", "Ithiel Town", "J. Cleaveland Cady",
    "Jacques Brownson", "James Corner Field Operations", "James Gibbs",
    "James O'Donnell", "James Renwick Jr.", "James Wardrop",
    "Jean-Michel Wilmotte", "Jeroni Martorell", "Jin Watanabe",
    "Jo Nagasaka", "John H. Duncan", "Jorge Colaço",
    ...
    "Karl Fournier", "Kazoo Sato", "Kazumasa Yamashita",
    "Kenichi Iwasaki", "Klein Dytham Architecture", "Kulapat Yantrasast",
    "Kunio Maekawa", "Lee Jae-yeon", "Lek Viriyaphant",
    "Lluís Clotet", "Luca Beltrami", "Ludger Lemieux",
    "Luigi Cagnola", "Luigi Vanvitelli", "Luis Rey",
    "Manuel Salgado", "Mara Servetto", "Mario Buschiazzo",
    "Mario Cucinella", "Mario Tamagno", "Mario Vodret",
    "Massimiliano Locatelli", "Michael Van Valkenburgh", "Michele De Lucchi",
    "Min Hyun-jun", "Minard Lafever", "Nelson Dupré",
    "Ngô Viết Thụ", "Nicola Salvi", "Norman Peebles",
    ...
    "Rafael Moneo", "Rafael Viñoly", "Ramon Reventós",
    "Richard Meier", "Richard Rogers", "Richard Upjohn",
    "Richard Waite", "Robert W. Gibson", "Roberto Peregalli",
    "Rod Faucheux", "Rodney Leon", "Seung H-Sang",
    "Silvia Bettini", "Stanford White", "Stefano Boeri",
    "Studio Tack", "Tamsin Johnson", "Thierry Despont",
    "Thom Mayne", "Thomas Dillen Jones", "Théophile Seyrig",
    "Tokuma Katayama", "Tomás Soler", "Tomás Taveira",
    "Viktor Sulčič", "Vittorio Gregotti", "Von Jour Caux",
    "Wallace Harrison", "Welton Becket", "Wes Anderson",
    "William Pereira", "William Pitt", "Work Architecture Company",
    "Yang Tae-oh", "Yoshio Taniguchi"
]

...
VOCAB = {
 ...
 "Architect": [
   ...
   "Edwin Lutyens", "Horace Jones", "Herbert Baker", "Amanda Levete",
   "Frederick Law Olmsted", "Calvert Vaux", "Richard Morris Hunt",
   "John Russell Pope", "Eero Saarinen", "Diller Scofidio + Renfro",
   "Jeanne Gang", "Michael Arad", "Marcel Breuer", "Francesco Tamburini",
   "Mario Palanti", "Carlos Thays", "Clorindo Testa", "Víctor Meano",
...
ARCH_KW = {
 "Álvaro Siza":["siza"], "Eduardo Souto de Moura":["souto de moura"],
 "Fernando Távora":["távora","tavora"], "Norman Foster":["norman foster","hsbc"],
 "Renzo Piano":["renzo piano"], "Frank Gehry":["gehry"],
 "Christopher Wren":["christopher wren"], "Charles Holden":["charles holden"],
 "Denys Lasdun":["lasdun"], "Inigo Jones":["inigo jones"],
 "Giles Gilbert Scott":["giles gilbert scott"],
 "George Gilbert Scott":["george gilbert scott"],
 "Herzog & de Meuron":["herzog & de meuron","de meuron"],
 "Frank Lloyd Wright":["frank lloyd wright","lloyd wright"],
 "Cass Gilbert":["cass gilbert"], "McKim, Mead & White":["mckim","stanford white"],
 "Inês Lobo":["inês lobo","ines lobo"],
 "Luís Pedro Silva":["luís pedro silva","luis pedro silva"],
 "Kengo Kuma":["kengo kuma"], "Kenzō Tange":["kenzo tange","kenzō tange"],
 "Tadao Ando":["tadao ando"], "SANAA":["sanaa","kazuyo sejima"],
 "Toyo Ito":["toyo ito"], "Fumihiko Maki":["fumihiko maki"],
 "Shigeru Ban":["shigeru ban"], "Sou Fujimoto":["sou fujimoto"],
 "Kisho Kurokawa":["kurokawa"], "I. M. Pei":["i.m. pei","i. m. pei","ieoh ming pei"],
 "Mies van der Rohe":["mies van der rohe"], "Le Corbusier":["le corbusier"],
 "Philip Johnson":["philip johnson"], "William Van Alen":["van alen"],
 "Thomas Heatherwick":["heatherwick"], "Santiago Calatrava":["calatrava"],
 "Bernard Maybeck":["maybeck"], "Daniel Burnham":["burnham"],
 "Zaha Hadid":["zaha hadid"], "Jean Nouvel":["jean nouvel"],
 ...
 "Hans Scharoun":["scharoun"], "August Endell":["august endell"],
 "Hermann Henselmann":["henselmann"], "Nicholas Hawksmoor":["hawksmoor"],
 "John Soane":["john soane","soane"], "Edwin Lutyens":["lutyens"],
 "Horace Jones":["horace jones"], "Herbert Baker":["herbert baker"],
 "Amanda Levete":["amanda levete","al_a"], "Frederick Law Olmsted":["olmsted"],
 "Calvert Vaux":["calvert vaux","vaux"], "Richard Morris Hunt":["richard morris hunt"],
 "John Russell Pope":["john russell pope"], "Eero Saarinen":["eero saarinen"],
 "Diller Scofidio + Renfro":["diller scofidio","diller, scofidio"],
 "Jeanne Gang":["jeanne gang","studio gang"], "Michael Arad":["michael arad"],
 "Marcel Breuer":["breuer"], "Francesco Tamburini":["tamburini"],
 "Mario Palanti":["palanti"], "Carlos Thays":["carlos thays","thays"],
 "Clorindo Testa":["clorindo testa"], "Víctor Meano":["víctor meano","victor meano"],
 "Jørn Utzon":["utzon"], "Joseph Reed":["joseph reed"], "Roy Grounds":["roy grounds"],
 "Marc Newson":["marc newson"], "Studio KO":["studio ko"],
 "Mario Botta":["mario botta","botta"], "Jun Aoki":["jun aoki"],

...
|---|------|------|------------------|----------|------|---------|
| 19 | LACMA / David Geffen Galleries | `lacma-geffen-galleries` | 34.0639, -118.3592 | visualArt | **PENDING — owner pasting Geffen bldg photos** | L25, L27 (Urban Light, Pexels) picked; more TBD |
...
## Status (2026-07-02)
- **DONE + pushed to gh-pages (`ea793bb`):** 24 Griffith (hero+5), 28 Santa Monica (hero+5), 20 La Brea (hero only).
...
- **19 LACMA — PENDING owner-supplied building photos.** The new Peter Zumthor **David Geffen Galleries** (opened 2026) is NOT in the free/stock/Wikimedia pool yet — the only genuine capture found was a construction-phase shot (Z41, cranes/fencing). Owner is pasting their own finished-building photos. Owner pre-picked **L25 + L27** (Urban Light night, Pexels) for the gallery; hero will be an owner-pasted Geffen shot.
...
**Blocked on:** (1) narration MP3s; (2) Atlas Studio LAX maker; (3) LACMA (19) owner-supplied Geffen building photos.

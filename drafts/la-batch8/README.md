...
Tour numbers are the owner's scheme (fills 18/23/32/33/43/44).
...
| 32 | Muscle Beach (original, Santa Monica) | `muscle-beach` | 34.0086, -118.4977 | culturalHeritage | MB12 (golden-hour acrobatics + SM Pier — Unsplash) | 1 (_2 MB1 "Original Location of Muscle Beach" sign) |
| 33 | Abbot Kinney Boulevard | `abbot-kinney` | 33.9910, -118.4670 | culturalHeritage | AK23 (Venice mural street — Pexels) | none (hero-only) |
...
- **32 Muscle Beach:** the SM ORIGINAL (not Venice's weight pen). Stock mixed in Muscle Beach Venice + SM Pier + beach volleyball. Both picks ship-safe: MB12 golden-hour acrobatics w/ pier ferris wheel (HERO), MB1 "Original Location of Muscle Beach" sign. (The distinctive swinging-rings arch only exists under CC — Wikimedia MW3/MW4 — owner went ship-safe-only.)
- **33 Abbot Kinney:** THIN + polluted (stock returned the Venice boardwalk sign, Venice **Italy**, Hollywood, even a NYC Jeffrey's Grocery). Only one Wikimedia shot confirms the actual street ("Looking down Abbot Kinney", CC). Owner chose a ship-safe Venice mural street (AK23) as a hero-only card. Fully accurate Abbot Kinney gallery would need owner-pasted photos.
...
- Getty (43) + Rodeo (44) + Muscle Beach (32) + Abbot Kinney (33): **none** — all ship-safe (Unsplash/Pexels/Pixabay).

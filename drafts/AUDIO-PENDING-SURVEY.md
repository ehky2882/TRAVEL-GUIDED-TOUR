...
| 🇫🇷 Paris — walks | 3 | 3 walks (Islands 5, Left Bank 6, Triumphal Way 6 stops) | 20 | `claude/dreamy-wozniak-nM6a4` | Atlas Studio PAR (exists) |
| 🇨🇦 Montreal | 5 | 5 single | 5 | `claude/amsterdam-handoff-preserve-hlhyp8` | **new** Atlas Studio YUL |
| **TOTAL PENDING** | **152** | | **253** | | |
...
_(⚠️ Paris: the **45 single-stop tours are LIVE** (PR #374), plus 2 walks LIVE — **"Le Marais" (PR #379)** and **"Montmartre" (PR #380)**, both 2026-07-08. The **remaining 3 Paris walks are still PENDING** (staged on `dreamy-wozniak-nM6a4`). Don't assume "Paris = done".)_
...
As of 2026-07-08, `origin/main` = **11 makers / 613 tours / 706 stops**. Live cities:
...
| **Paris** | 45 | **PAR** | **launched 2026-07-08 (PR #374)** — 45 single-stop + **2 walks (Le Marais #379, Montmartre #380)**. **3 more Paris walks still PENDING** (above). |

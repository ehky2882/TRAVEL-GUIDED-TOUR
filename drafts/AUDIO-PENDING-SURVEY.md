...
| 🇫🇷 Paris — walks | 4 | 4 walks (Islands 5, Left Bank 6, Montmartre 5, Triumphal Way 6 stops) | 26 | `claude/dreamy-wozniak-nM6a4` | Atlas Studio PAR (exists) |
| 🇨🇦 Montreal | 5 | 5 single | 5 | `claude/amsterdam-handoff-preserve-hlhyp8` | **new** Atlas Studio YUL |
| **TOTAL PENDING** | **153** | | **259** | | |
...
_(⚠️ Paris: the **45 single-stop tours are LIVE** (PR #374), and **"Le Marais" walk went LIVE 2026-07-08 (PR #379)**. The **remaining 4 Paris walks are still PENDING** (staged on `dreamy-wozniak-nM6a4`). Don't assume "Paris = done".)_
...
As of 2026-07-08, `origin/main` = **11 makers / 612 tours / 700 stops**. Live cities:
...
| **Paris** | 45 | **PAR** | **launched 2026-07-08 (PR #374)** — 45 single-stop + **1 walk "Le Marais" (PR #379)**. **4 more Paris walks still PENDING** (above). |

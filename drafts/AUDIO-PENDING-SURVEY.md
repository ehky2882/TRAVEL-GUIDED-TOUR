...
| 🇫🇷 Paris — walks | 2 | 2 walks (Islands 5, Left Bank 6 stops) | 13 | `claude/dreamy-wozniak-nM6a4` | Atlas Studio PAR (exists) |
| 🇨🇦 Montreal | 5 | 5 single | 5 | `claude/amsterdam-handoff-preserve-hlhyp8` | **new** Atlas Studio YUL |
| **TOTAL PENDING** | **151** | | **246** | | |
...
_(⚠️ Paris: the **45 single-stop tours are LIVE** (PR #374), plus 3 walks LIVE — **Le Marais (#379)**, **Montmartre (#380)**, **The Triumphal Way (#381)**, all 2026-07-08. The **remaining 2 Paris walks are still PENDING** (staged on `dreamy-wozniak-nM6a4`). Don't assume "Paris = done".)_
...
As of 2026-07-08, `origin/main` = **11 makers / 614 tours / 713 stops**. Live cities:
...
| **Paris** | 45 | **PAR** | **launched 2026-07-08 (PR #374)** — 45 single-stop + **3 walks (Le Marais #379, Montmartre #380, Triumphal Way #381)**. **2 more Paris walks still PENDING** (above). |

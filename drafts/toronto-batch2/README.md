# Toronto — single-stop tours, batch 2 (audio pending) 🇨🇦

Image-staged 2026-06-30. Continues the Toronto city build (see `toronto-batch1`).
Single-stop, geofenced, maker **Atlas Studio YYZ** (create at first Toronto wire-in).

NOTE: sourced while Gemini's AI verify gate was down (503), so these were
eyeball-verified by owner + montage spot-checks (not the AI gate).
...
Most ship-safe (Unsplash/Pexels). Hockey Hall gallery is Wikimedia — see credits below.

**Image credits (Hockey Hall gallery, non-ship-safe):**
- `hockey-hall-of-fame_2.webp` (NHL Zone): "DSC 2009" by Christopher Amrich, CC BY-SA 2.0
- `hockey-hall-of-fame_3.webp` (Canadiens Stanley Cup display): "Babillard des coupes Stanley des Canadiens de Montréal" by Cloutz91, CC0 (no attribution needed)
- `hockey-hall-of-fame_4.webp` (goalie mask exhibit): "DSC 2018" by Christopher Amrich, CC BY-SA 2.0

**Blocked on:** (1) narration MP3s; (2) the **Atlas Studio YYZ** maker.

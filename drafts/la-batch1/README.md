...
| 09 | El Pueblo / Olvera Street | `el-pueblo-olvera-street` | 34.0574, -118.2378 | culturalHeritage | owner-supplied (vendor-stall street) | 2 (_2 willow street, _3 plaza church) |
...
## Status (2026-07-02)
- **DONE + pushed to gh-pages:** 01, 02, 04, 08, 09, 12, 13, 15 (all 8 tours). Heroes + galleries all cropped and live. **LA batch 1 image-staging COMPLETE.**
- **09 El Pueblo / Olvera Street — DONE (owner-supplied, 3 photos).** Hero = the colorful vendor-stall street alley (per owner: "one of the streets as the hero"); `_2` = the willow-shaded market street; `_3` = the La Placita plaza church (tiled dome + historic lamp post). Cropped 1200×900 WebP, pushed to gh-pages (`718d3c7`). Owner-supplied = no credit. Stock had badly misfired here (returned Paramount / Universal / Broadway), so the owner pasted their own — resolved.
...
- El Pueblo / Olvera Street (09) — all 3 images owner-supplied = no credit.
...
**Blocked on:** (1) narration MP3s; (2) the Atlas Studio LAX maker. (Images all complete.)

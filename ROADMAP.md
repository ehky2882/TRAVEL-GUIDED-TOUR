...
- [~] **In-app account deletion** (Apple Guideline 5.1.1(v)) — **built 2026-09-13, branch `claude/account-self-delete`, awaiting owner setup + device pass.** Settings → Account → Delete account → `delete-account` Edge Function + `backend/account_deletion.sql`. Owner rule: remove unsold tours, keep sold ones as "Former creator". See `docs/account-deletion.md`.

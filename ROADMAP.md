...
| **7. Maker payouts** | Stripe Connect (Tier 2 #5) | ⬜ Not started. ⚠️ **The Stripe account is under Restricted Businesses review** (opened 2026-08-18, three rounds answered as of 2026-08-19, decision pending, deadline Sep 17). A restricted account blocks this step outright, so read **`docs/stripe-review.md`** before any payout work — it holds every answer already given, and nothing further may contradict them. |

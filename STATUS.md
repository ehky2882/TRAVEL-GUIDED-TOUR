...
the builder times out and the served endpoint does not.** ⚠️ **The second half of that criterion does NOT hold: the served endpoint still times out on roughly 1 call in 10.** The builder moving off the request path is real; the endpoint being reliable is not yet true.

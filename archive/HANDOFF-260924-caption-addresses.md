...
## 2026-09-25: #1086 follow-up (rule 8c)
Another session's 28-pin batch (#1086) landed three pins on the same name as existing Seoul tours and a fourth on the same venue handle. **4 places minted** (Centre Pompidou Hanwha, HAUS NOWHERE SEOUL, Seo-Seoul Museum of Art, Photo SeMA) and **2 joins** at 0 m (Fondation Maeght, Millennium Bridge). **Put to the owner:** *MMCA Gwacheon* + *The More the Better, Nam June Paik* share a point. That is part vs whole, a pairing the owner has declined every time.

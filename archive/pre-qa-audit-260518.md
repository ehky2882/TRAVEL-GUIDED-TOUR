...
> **Archived 2026-05-18.** Findings are now tracked as a live
> checklist in `ROADMAP.md` § M-qa. The closed PRs are the
> authoritative record of fixes; this doc is the historical
> snapshot of the audit pass itself. **Do not edit this file** —
> any new audit work should produce a new dated doc in `docs/`,
> and triage should update the ROADMAP checklist.

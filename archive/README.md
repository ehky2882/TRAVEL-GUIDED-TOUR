...
|---|---|---|
| `HANDOFF-260912-3.md` | The splash's brass circle breathes again (owner: *"i never wanted it to go away"*). #559 had swapped the 1.0↔0.2 fade for an invisible 10% size pulse. 🔴 **Restored on Core Animation, not SwiftUI** — measured: a SwiftUI fade held each value up to 0.5s because the map is built behind the splash on the main thread; the layer animation glides. | 2026-09-12 |

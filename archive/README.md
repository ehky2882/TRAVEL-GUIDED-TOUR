...
| `HANDOFF-260524.md` | **Active handoff.** Mac session 2026-05-23/24: populated `heroImageURL` for all 38 tours via CC-licensed Wikimedia Commons photos (landscape-optimised batch), bumped build number to 7, opened Xcode for TestFlight upload. Owner needs to Archive → Upload to complete build 7. | 2026-05-24 |

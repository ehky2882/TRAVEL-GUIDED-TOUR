...
| [HANDOFF-260914-6.md](HANDOFF-260914-6.md) | **Scaling pinned tours to 100,000 — design, and the four things worth building before any creator outreach.** 🔴 Found **~32 pins already live and INVISIBLE** behind `TourSetMap.maxStacked = 3` (19 coincident groups over 3, covering 87 pins), and `check-place-candidates.py` **exiting 1 with 15 EXACT**. 🔴 The delta doc **understates its own payoff ~4×** — a seed writes **~14,176 row versions**, of which **stops are 8,234**, and its *preferred* option does not fix them. Design only; no code, no catalogue change. | (session 157, 2026-09-14) |

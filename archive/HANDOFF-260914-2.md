...
the same reel pasted twice. **34 became pins**; the other five are itemised below.
...
**The Georgia waterfall and the NoHo restaurant are with the owner**, who said
they would check what they are. Each is one command once named; the coordinate is

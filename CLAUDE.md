...
**Latest TestFlight build: 1.0 (57)** — live 2026-06-30. Adds **"Report a concern"** (#290) + the sign-out write-through flush fix (#291). The Step-3 build arc: 51 email · 52 Apple · 53 Google · 54 library/makers sync · 55 logout-clear · 56 Recents fix + recently-viewed sync · 57 reports + sync flush.

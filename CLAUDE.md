...
**Latest TestFlight build: 1.0 (56)** — adds the Recents-recording fix (#285) + recently-viewed cross-device sync (#287). The Step-3 build arc: 51 email · 52 Apple · 53 Google · 54 library/makers sync · 55 logout-clear · 56 Recents fix + recently-viewed sync. (Apple device-confirmed; sync + Recents fix pending owner device retest on 56.)

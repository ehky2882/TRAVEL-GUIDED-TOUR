...
**Regenerated 2026-09-23 19:35 UTC against `main` at `178f0f32`.** Every number here is a reading of
...
**441 places covering 1079 entries**.
...
| **§ 3** | 35 same-subject pairs 25–500 m apart | Read one at a time |
...
at 1e-9°), every member is **snapped onto that coordinate** — all 1079 existing members sit
...
## § 3 — 35 same-subject pairs 25–500 m apart
...
| N3 | New York | 32 m | `[pin]` Inside the Museum of the City of New York<br>`[tour]` Museum of the City of New York |
| N4 | Ahmedabad | 53 m | `[pin]` Lilavati Lalbhai Library, CEPT University<br>`[pin]` CEPT University |
| N5 | Paris | 58 m | `[pin]` Toilettes de la Madeleine<br>`[tour]` La Madeleine |
| N6 | Atlanta | 62 m | `[tour]` Oakland Cemetery<br>`[pin]` Historic Oakland Cemetery |
| N7 | Porto | 75 m | `[pin]` São Bento Railway Station<br>`[tour]` São Bento Station |
| N8 | Paris | 87 m | `[tour]` Place des Vosges<br>`[pin]` Carette, Place des Vosges |
| N9 | New York | 88 m | `[pin]` The Stacks Under Bryant Park *(in New York Public Library, Stephen A. Schwarzman Building)*<br>`[tour]` Bryant Park |
| N10 | New York | 89 m | `[tour]` Little Island, Southwest Overlook<br>`[pin]` Little Island |
| N11 | Seoul | 89 m | `[tour]` Cheonggyecheon \| 청계천<br>`[pin]` Cheonggyecheon Stream |
| N12 | Seoul | 100 m | `[pin]` Mrs. Cho's Noodles, Gwangjang Market<br>`[tour]` Gwangjang Market \| 광장시장 |
| N13 | London | 131 m | `[pin]` The Painted Hall<br>`[pin]` The Painted Hall, Greenwich |
| N14 | Chicago | 142 m | `[tour]` The Wrigley Building & Tribune Tower<br>`[pin]` Tribune Tower *(in Tribune Tower)* |
| N15 | Chicago | 142 m | `[tour]` The Wrigley Building & Tribune Tower<br>`[pin]` Tribune Tower *(in Tribune Tower)* |
| N16 | New York | 147 m | `[pin]` Times Square *(in Times Square)*<br>`[tour]` Times Square — The View from the Red Steps |
| N17 | Beverly Hills | 160 m | `[pin]` Tory Burch, Rodeo Drive<br>`[tour]` Rodeo Drive |
| N18 | Paris | 167 m | `[tour]` Louvre *(in Louvre)*<br>`[pin]` Musée du Louvre |
| N19 | New York | 173 m | `[pin]` The Times Square Mosaic Map<br>`[pin]` Times Square *(in Times Square)* |
| N20 | Chichén Itzá | 224 m | `[pin]` Chichén Itzá *(in Chichén Itzá)*<br>`[pin]` The Great Ball Court, Chichén Itzá |
| N21 | Dundee | 236 m | `[pin]` The Old Bank Bar<br>`[pin]` The Bank Bar |
| N22 | London | 237 m | `[pin]` Did you know there’s a 1970s laundrette in The Barbican?…<br>`[pin]` The Barbican *(in Barbican Centre)* |
| N23 | London | 243 m | `[pin]` Did you know there’s a 1970s laundrette in The Barbican?…<br>`[tour]` The Barbican *(in The Barbican)* |
| N24 | San Francisco | 257 m | `[tour]` Chinatown: The City That Refused to Move<br>`[pin]` Chinatown |
| N25 | Paris | 283 m | `[pin]` Petit Palais *(in Petit Palais)*<br>`[tour]` Pont Alexandre III & Petit Palais |
| N26 | Paris | 283 m | `[pin]` Petit Palais *(in Petit Palais)*<br>`[tour]` Pont Alexandre III & Petit Palais |
| N27 | Hong Kong | 289 m | `[pin]` Kowloon Park Stone Columns \| 九龍公園百年石柱<br>`[pin]` Kowloon Park |
| N28 | Stockholm | 301 m | `[tour]` Gamla stan 1859<br>`[tour]` Gamla stan *(in Gamla stan)* |
| N29 | Paris | 302 m | `[pin]` Cinéma du Panthéon<br>`[tour]` Panthéon |
| N30 | London | 352 m | `[pin]` Choosing Keeping in Covent Garden<br>`[tour]` Covent Garden *(in Covent Garden)* |
| N31 | Brooklyn | 364 m | `[pin]` The Cyclone at Coney Island<br>`[tour]` Coney Island |
| N32 | New York | 368 m | `[pin]` Roy Lichtenstein's Times Square Mural<br>`[pin]` Times Square *(in Times Square)* |
| N33 | San Francisco | 395 m | `[tour]` Chinatown Dragon Gate<br>`[pin]` Chinatown |
| N34 | Kyoto | 418 m | `[pin]` Gion Kurashita, Hanamikoji, Gion, Kyoto<br>`[tour]` Gion \| 祇園 *(in Gion)* |
| N35 | Naoshima | 455 m | `[tour]` Benesse House Museum \| ベネッセハウス ミュージアム<br>`[tour]` Benesse House Museum Outdoor Works \| ベネッセハウスミュージアム屋外作品 |
